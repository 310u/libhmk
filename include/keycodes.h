...
typedef enum {
  ...
  SP_SNIPER = 0xD6,
  SP_JOY_SCROLL_MO = 0xD7,
  SP_RGB_TOGGLE = 0xD8,
  SP_RGB_BRIGHTNESS_UP = 0xD9,
  SP_RGB_BRIGHTNESS_DOWN = 0xDA,
  SP_POLL_RATE_TOGGLE = 0xDB,
  ...
  JY_SCROLL_MO = SP_JOY_SCROLL_MO,
  RGB_TOG = SP_RGB_TOGGLE,
  RGB_BRIU = SP_RGB_BRIGHTNESS_UP,
  RGB_BRID = SP_RGB_BRIGHTNESS_DOWN,
  POLL_TOG = SP_POLL_RATE_TOGGLE,
} keycode_t;
