...
typedef enum {
  ...
  SP_RGB_EFFECT_NEXT = 0xDC,
  SP_RGB_EFFECT_PREV = 0xDD,
  SP_JOY_PRESET_NEXT = 0xDE,
  SP_JOY_SCROLL_PROFILE_NEXT = 0xDF,
  SP_MOUSE_WHEEL_UP = 0xE0,
  SP_MOUSE_WHEEL_DOWN = 0xE1,
  SP_MOUSE_PAN_LEFT = 0xE2,
  SP_MOUSE_PAN_RIGHT = 0xE3,
  SP_TRACKBALL_CPI_UP = 0xE4,
  SP_TRACKBALL_CPI_DOWN = 0xE5,
  SP_TRACKBALL_PRESET_NEXT = 0xE6,
  ...
  JY_PRESET = SP_JOY_PRESET_NEXT,
  JY_SCROLL_MO = SP_JOY_SCROLL_MO,
  JY_SCROLL_PROFILE = SP_JOY_SCROLL_PROFILE_NEXT,
  MS_WHLU = SP_MOUSE_WHEEL_UP,
  MS_WHLD = SP_MOUSE_WHEEL_DOWN,
  MS_PANL = SP_MOUSE_PAN_LEFT,
  MS_PANR = SP_MOUSE_PAN_RIGHT,
  T_CPI_UP = SP_TRACKBALL_CPI_UP,
  T_CPI_DN = SP_TRACKBALL_CPI_DOWN,
  T_PRESET = SP_TRACKBALL_PRESET_NEXT,
  RGB_TOG = SP_RGB_TOGGLE,
  RGB_MOD = SP_RGB_EFFECT_NEXT,
  RGB_RMOD = SP_RGB_EFFECT_PREV,
...
#define MOUSE_SCROLL_KEYCODE_RANGE SP_MOUSE_WHEEL_UP... SP_MOUSE_PAN_RIGHT
