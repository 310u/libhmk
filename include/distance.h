...
// Default switch-travel curve. Reproduces the logarithmic lookup table that was
// previously generated by tools/distance_lut.py, sampled at 9 control points.
// Distance rises quickly near the start of travel and flattens near bottom-out.
#define DEFAULT_DISTANCE_CURVE                                                 \
  {                                                                            \
      .num_points = 9,                                                         \
      .total_travel_um = 4000,                                                 \
      .points =                                                                \
          {                                                                    \
              {0, 0},                                                          \
              {32, 82},                                                        \
