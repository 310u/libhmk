...
static const uint8_t desc_mouse_report[] = {
    ...
    // Let modern hosts opt into high-resolution wheel scrolling while legacy
    // hosts continue to treat the interface like a regular wheel mouse.
    ...
    HID_LOGICAL_MAX(1),
    HID_PHYSICAL_MIN(1),
    HID_PHYSICAL_MAX(HID_MOUSE_WHEEL_RESOLUTION_MULTIPLIER),
    HID_REPORT_COUNT(1),
    HID_REPORT_SIZE(1),
